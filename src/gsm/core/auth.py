...
class OAuthDesktopAuth:
    ...
    def _load_or_refresh(self) -> Credentials:
        ...
        if creds is not None and creds.expired and creds.refresh_token:
            try:
                ...
                _log.warning("oauth_refresh_failed", error=str(e))
                creds = None
    ...
    def _load_from_disk(self) -> Credentials | None:
        ...
        try:
            ...
            _log.warning("oauth_token_load_failed", path=str(self._token_path), error=str(e))
            return None
    ...
    def _run_browser_flow(self) -> Credentials:
        ...
        flow = InstalledAppFlow.from_client_secrets_file(str(self._client_path), self.SCOPES)
